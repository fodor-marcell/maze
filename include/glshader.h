...
static int initWorldShaderProgram(void)
{
...
static void beginWorldShader(const GLfloat lightPosWorld[4], const GLfloat lightDirWorld[3],
...
static void setWorldShaderUseTexture(int enabled)
{
    if (worldShaderProgram == 0)
    {
        return;
